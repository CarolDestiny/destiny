...
#define DESTINY_INT_TEST_BODY(T, U)                                            \
    ...
    {                                                                          \
        ...
        {                                                                      \
            EXPECT_EQ((-T(static_cast<U>(1))).value(),                         \
    ...
    {                                                                          \
        ...
        {                                                                      \
            EXPECT_EQ((~T(static_cast<U>(0))).value(),                         \
                      std::numeric_limits<U>::max());                          \
        }                                                                      \
    }                                                                          \
    {                                                                          \
    ...
    {                                                                          \
        EXPECT_EQ(T(static_cast<U>(1)) <=> T(static_cast<U>(2)),               \
                  std::strong_ordering::less);                                 \
        EXPECT_EQ(T(static_cast<U>(2)) <=> T(static_cast<U>(2)),               \
                  std::strong_ordering::equal);                                \
        EXPECT_EQ(T(static_cast<U>(3)) <=> T(static_cast<U>(2)),               \
    ...
    {                                                                          \
        EXPECT_EQ(T(std::numeric_limits<U>::min()).value(),                    \
                  std::numeric_limits<U>::min());                              \
        EXPECT_EQ(T(std::numeric_limits<U>::max()).value(),                    \
                  std::numeric_limits<U>::max());                              \
    }
