# =====================================================================
# llvm-mingw Clang toolchain (x64 / x86)
#
# [To change machines, edit here - path configuration]
# Supports three install layouts, pick one:
#   A. x64/x86 under the same root (this machine: D:/cpp/toolchains/llvm-mingw has x64/, x86/)
#      -> set DESTINY_TOOLCHAIN_CLANG_ROOT
#   B. x64 and x86 installed separately -> set DESTINY_TOOLCHAIN_CLANG_X64_ROOT /
#      DESTINY_TOOLCHAIN_CLANG_X86_ROOT (unified root can stay empty)
...
set(DESTINY_TOOLCHAIN_CLANG_ROOT     "D:/cpp/toolchains/llvm-mingw" CACHE STRING "llvm-mingw unified root (contains x64/, x86/); use either this or the two separate roots")
set(DESTINY_TOOLCHAIN_CLANG_X64_ROOT "" CACHE STRING "llvm-mingw x64 standalone root (alternative to unified root)")
set(DESTINY_TOOLCHAIN_CLANG_X86_ROOT "" CACHE STRING "llvm-mingw x86 standalone root (alternative to unified root)")
...
if(NOT DEFINED DESTINY_TOOLCHAIN_ARCH)
  message(FATAL_ERROR "No usable Clang toolchain found. Configure the paths at the top of this file, or pass DESTINY_TOOLCHAIN_ARCH=x64/x86 in the preset")
endif()
...
if(DESTINY_TOOLCHAIN_ARCH STREQUAL "x86")
  if(NOT EXISTS "${DESTINY_CLANG_X86_BIN}/clang++.exe")
    message(FATAL_ERROR "x86 requested but compiler not found: ${DESTINY_CLANG_X86_BIN}/clang++.exe\nAvailable: ${DESTINY_CLANG_AVAILABLE}")
  endif()
  ...
  # runtime). Copy them next to the output dir (bin/) after building so they
  # can run.
  ...
  if(NOT EXISTS "${DESTINY_CLANG_X64_BIN}/clang++.exe")
    message(FATAL_ERROR "x64 requested but compiler not found: ${DESTINY_CLANG_X64_BIN}/clang++.exe\nAvailable: ${DESTINY_CLANG_AVAILABLE}")
  endif()
